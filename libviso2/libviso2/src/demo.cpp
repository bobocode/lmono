...
int main (int argc, char** argv) {
  ...
  param.calib.cu = 607.193; // principal point (u-coordinate) in pixels
  param.calib.cv = 185.216; // principal point (v-coordinate) in pixels
  param.base     = 0.537166; // baseline in meters
