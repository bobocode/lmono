...
Marginalization::Marginalization(MarginalizationInfo* _marginalization_info): marginalization_info(_marginalization_info)
{
    int cnt=0;
...
bool Marginalization::Evaluate(double const *const *parameters, double *residuals, double **jacobians) const
{
    return EvaluateWithMinimalJacobians(parameters, residuals, jacobians, NULL);
}

bool Marginalization::EvaluateWithMinimalJacobians(double const *const *parameters,double *residuals, double **jacobians,double **jacobiansMinimal) const 
{
    ...
    for (int i = 0; i < static_cast<int>(marginalization_info->keep_block_size.size()); i++)
    {
        ...
        else
        {
            ...
            dx.segment<3>(idx + 3)
                    = 2.0 * mathutils::positify(Eigen::Quaterniond(x0(6), x0(3), x0(4), x0(5)).inverse() * Eigen::Quaterniond(x(6), x(3), x(4), x(5))).vec();
